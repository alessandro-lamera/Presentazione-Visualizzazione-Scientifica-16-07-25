...
popolazione.append(df.at[13,"Totale"])
popolazione.append(dg.at[13,"Totale"])
popolazione.append(dh.at[13,"Totale"])
popolazione.append(di.at[13,"Totale"])
popolazione.append(dl.at[13,"Totale"])
popolazione.append(dm.at[11,"Totale"])

plt.plot(time,popolazione, c='#0099FF', alpha=0.7)
plt.title("Andamento della popolazione negli anni",fontsize=15)
